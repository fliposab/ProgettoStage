...
= Introduzione
== Scopo del documento
Il presente documento ha lo scopo di descrivere i requisiti del videogioco sviluppato con il motore di gioco #gloss[Godot]. 
Vengono elencati tutti i casi d'uso e le interazioni tra il giocatore e il gioco, accompagnati da diagrammi UML per facilitare la comprensione.\
Inoltre, vengono analizzati i requisiti funzionali, di vincolo, di qualità e di accessibilità.
...
#figure(image("imgs/uc-interazione_automatica.png", width: auto), caption: "Interazione entità automatica")
*Attori principali*: 
- Giocatore
*Descrizione*:
- Il giocatore si avvicina a un'entità.
*Precondizioni*:
- Il giocatore deve essere vicino ad un'entità.
*Postcondizioni*:
- Il giocatore interagisce con l'entità.
*Scenario principale*:
- Il giocatore si avvicina ad un'entità.
- L'interazione avviene automaticamente.
*Generalizzazioni*:
...
- Giocatore
*Descrizione*:
- Il giocatore vuole visualizzare il messaggio di un'entità del gioco.
*Precondizioni*:
- Il giocatore deve essere lontano dall'entità.
*Postcondizioni*:
...
- Il giocatore deve essere vicino ad un'entità.
*Postcondizioni*:
- Il giocatore ha premuto l'input per interagire.
*Scenario principale*:
- Il giocatore si avvicina ad un'entità.
...
- Il giocatore vede l'input che deve premere per interagire.
*Precondizioni*:
- Il giocatore deve essere vicino a un personaggio non giocabile.
*Postcondizioni*:
- Il giocatore ha premuto l'input per interagire.
*Scenario principale*:
- Il giocatore si avvicina a un personaggio non giocabile.
...
== UC11 - Interazione con un cartello
#figure(image("imgs/uc-interazione_cartello.png", width: auto), caption: "Interazione cartello")
*Attori principali*:
- Giocatore.
*Descrizione*:
...
== UC12 - Interazione con zona di transizione
#figure(image("imgs/uc-transizione.png", width: auto), caption: "Interazione zona di transizione")
*Attori principali*: 
- Giocatore.
*Descrizione*:
...
- Giocatore
*Descrizione*:
- Il giocatore vuole interagire con la macchina per posizionare dei punti sul grafico #gloss[LR].
*Precondizioni*:
...
#figure(
  ...
  table(
    ...
    //UC2.1
    [R-04-F-O],[Il giocatore deve essere in grado di saltare con un oggetto in mano],[UC2.1\ Decisione interna],
    //UC3, 3.1
    [R-05-F-O],
    ...
    [UC7.2\ Discussione con il tutor aziendale],
    //UC8.1
    [R-12-F-O],
    ...
    [UC11.1\ Discussione con il tutor aziendale],
    //UC11.2
    [R-20-F-O],
    [Il giocatore deve poter visualizzare gli oggetti che ha classificato correttamente],
    [UC11.2\ Discussione con il tutor aziendale],
    //UC11.3
    [R-21-F-O],
    [Il giocatore deve poter visualizzare il grafico di un cartello],
    [UC11.3\ Discussione con il tutor aziendale],
    //UC11.4
    [R-22-F-O],[Il giocatore deve poter modificare i dati presenti in un cartello],[UC11.4\ Discussione con il tutor aziendale],
    //UC12
    [R-23-F-O],
    ...
    //UC16
    [R-28-F-O],[Il giocatore deve poter salire sopra un nodo dell'albero di decisione],[UC16\ Discussione con il tutor aziendale],
    //UC16.1
    [R-29-F-O],[Il giocatore deve poter visualizzare le scelte da prendere sopra il nodo],[UC16.1\ Discussione con il tutor aziendale],
    //UC17
    [R-30-F-O],
    ...
    [UC17.1\ Discussione con il tutor aziendale],
    //UC17.2
    [R-32-F-O],
    [Il giocatore deve poter visualizzare se l'oggetto posto sul nodo sia sbagliato],
    [UC17.2\ Discussione con il tutor aziendale],
    //UC18
    [R-33-F-O],
...
#figure(
  ...
  table(
    ...
    "R-03-F-O", "UC2","\u{2713}",
    "R-04-F-O", "UC2.1","\u{2713}",
    "R-05-F-O", "UC3, UC3.1","\u{2713}",
    "R-06-F-O", "UC3, UC3.2","\u{2713}",
    "R-07-F-O", "UC4, UC5","\u{2713}",
    "R-08-F-O", "UC6","\u{2713}",
    "R-09-F-O", "UC7","\u{2713}",
    "R-10-F-O", "UC7.1, UC7.1.1","\u{2713}",
    "R-11-F-O", "UC7.2","\u{2713}",
    "R-12-F-D", "UC8.1","\u{2713}",
    "R-13-F-O", "UC8.2","\u{2713}",
    "R-14-F-O", "UC8.3","\u{2713}",
    "R-15-F-O", "UC8.4","\u{2713}",
    "R-16-F-O", "UC9","\u{2713}",
    "R-17-F-O", "UC10","\u{2713}",
    "R-18-F-O", "UC11","\u{2713}",
    "R-19-F-O", "UC11.1","\u{2713}",
    "R-20-F-O", "UC11.2","\u{2713}",
    "R-21-F-O", "UC11.3","\u{2713}",
    "R-22-F-O", "UC11.4","\u{2713}",
    "R-23-F-D", "UC12","\u{2713}",
    "R-24-F-O", "UC12.1","\u{2713}",
    "R-25-F-O", "UC13","\u{2713}",
    "R-26-F-O", "UC14","\u{2713}",
    "R-27-F-D", "UC15","\u{2713}",
    "R-28-F-O", "UC16","\u{2713}",
    "R-29-F-O", "UC16.1","\u{2713}",
    "R-30-F-O", "UC17","\u{2713}",
    "R-31-F-O", "UC17.1","\u{2713}",
    "R-32-F-O", "UC17.2","\u{2713}",
    "R-33-F-O", "UC18","\u{2713}",
    "R-34-F-O", "UC19","\u{2713}",
    "R-35-F-O", "UC20","\u{2713}",
    "R-36-F-O", "UC21","\u{2713}",
    "R-37-F-O", "UC22","\u{2713}",
    "R-38-F-D", "UC23","\u{2713}",
    "R-39-F-O", "UC24","\u{2713}",
    "R-40-F-O", "UC25","\u{2713}",
    "R-41-F-O", "UC26","\u{2713}",
    "R-42-F-O", "UC27","\u{2713}",
    "R-43-F-O", "UC28","\u{2713}",
    "R-44-F-D", "UC29","\u{2713}",
    "R-45-F-D", "UC30","\u{2713}",
    "R-46-F-D", "UC31","\u{2713}",
    "R-47-F-D", "UC32","\u{2713}",
    "R-48-F-D", "UC33","\u{2713}",
